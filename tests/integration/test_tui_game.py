...
class TestNarrativeGameFlow:
    ...
    async def test_can_open_character_from_game(self, app):
        """Test pressing 'c' opens character screen from game."""
        async with app.run_test() as pilot:
            await pilot.pause()
            await pilot.click("#btn_new")
            await pilot.pause()
            ...
            assert "character" in type(app.screen).__name__.lower()

    async def test_can_open_inventory_from_game(self, app):
        """Test pressing 'i' opens inventory screen from game."""
        async with app.run_test() as pilot:
            await pilot.pause()
            await pilot.click("#btn_new")
            await pilot.pause()
            ...
            assert "inventory" in type(app.screen).__name__.lower()

    async def test_can_open_log_from_game(self, app):
        """Test pressing 'l' opens log screen from game."""
        async with app.run_test() as pilot:
            await pilot.pause()
            await pilot.click("#btn_new")
            await pilot.pause()
            ...
            assert "log" in type(app.screen).__name__.lower()
